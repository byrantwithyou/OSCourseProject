...
void help()
{
    ...
    printf("5.  pwd                           : Show current directory\n");
	printf("6.  create      [file]            : Create a new file\n");
    printf("7.  cat         [file]            : Print the file\n");
    printf("8.  vi          [file]            : Modify the content of the file\n");
    printf("9.  delete      [file]            : Delete a file\n");
...
//    printf("11. encrypt     [file]            : Encrypt a file\n");
	...
	printf("14. calendar                      : Show the calendar\n");
	printf("15. calculator                    : Calculate, eg. calendar 2+6\n");
    printf("16. minesweeper                   : The Minesweeper Game\n");
	printf("17. gobang                        : The GoBang Game\n");
	printf("18. shutdown                      : Shut the computer down\n");
    printf("==============================================================================\n");
}
   ...
   char current_dirr[512] = "/";
    ...
    while (1) {  
        ...
        else if (strcmp(cmd, "create") == 0)
        {
			...
			printf("create=====debug======arg1======\n");
			printf("%s\n", arg1);
			printf("create=====debug======temp======\n");
			printf("%s\n", temp);
			printf("create=====debug======current_dirr====\n");
			printf("%s\n", current_dirr);
